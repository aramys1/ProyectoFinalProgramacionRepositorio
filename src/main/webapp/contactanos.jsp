...
<body>
    <nav class="navbar retro-window">
        ...
        { %>
            ...
            <li>
                <a href="${pageContext.request.contextPath}/login.jsp" class="retro-button">Iniciar Sesión</a>
            </li>
            <% } %>
        </ul>
    </nav>
    ...
    <div class="content-section">
            ...
            <div class="team-grid">
                ...
                <div class="retro-window member-card">
                    ...
                    <div class="member-details">
                        ...
                        <p class="member-experience">
                            <strong>Resumen:</strong> Especializada en arquitectura de bases
                            de datos relacionales y optimización de consultas SQL. Ha
                            colaborado en el diseño lógico de módulos de inventario y
                ...
                <div class="retro-window member-card">
                    ...
                    <div class="member-details">
                        ...
                        <p class="member-experience">
                            <strong>Resumen:</strong> Enfocado en el desarrollo ágil
                            orientado a objetos y la implementación de lógica comercial en
                            Java. Encargado del control de transacciones de alquiler y
                            flujos backend eficientes.
                        </p>
                ...
                <div class="retro-window member-card">
                    ...
                    <div class="member-details">
                        ...
                        <p class="member-experience">
                            <strong>Resumen:</strong> Apasionada por el diseño modular y el
                            desacoplamiento de componentes. Cuenta con experiencia sólida
                            gestionando la persistencia de datos y la validación segura de
                            formularios web.
                        </p>
                ...
                <div class="retro-window member-card">
                    ...
                    <div class="member-details">
                        ...
                        <p class="member-experience">
                            <strong>Resumen:</strong> Desarrollador enfocado en soluciones
                            limpias usando patrones de diseño arquitectónicos. Lideró la
                            sincronización de las vistas dinámicas JSP con el modelo del
                            servidor local.
                        </p>
                ...
                <div class="retro-window member-card">
                    ...
                    <div class="member-details">
                        ...
                        <p class="member-experience">
                            <strong>Resumen:</strong> Encargado de la maquetación responsiva
                            e interactiva. Cuenta con trayectoria integrando estilos
                            complejos y animaciones ligeras que preservan la fidelidad de
                            interfaces retro.
                        </p>
                ...
                <div class="retro-window member-card">
                    ...
                    <div class="member-details">
                        ...
                        <p class="member-experience">
                            <strong>Resumen:</strong> Orientado al testing de sistemas y
                            depuración de errores críticos de ejecución en entornos
                            distribuidos. Ha supervisado el correcto mapeo relacional de la
        ...
        <div class="retro-window store-window">
            ...
            <div class="store-content">
                ...
                <p>
                    <strong>Ubicación:</strong> Facultad de Ingeniería de Sistemas
                    Computacionales, Edificio 3, Universidad Tecnológica de Panamá.
                </p>
