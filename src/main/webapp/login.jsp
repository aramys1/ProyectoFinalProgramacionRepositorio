...
<%
    ...
    /* POST: valida las credenciales enviadas por el formulario. */
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        String cedula = request.getParameter("usuario") != null
        ...
        String sql = "SELECT ID_USUARIO, CED_USUARIO, ROL "
                + "FROM USUARIO WHERE CED_USUARIO = ? AND CONTRASENA = ?";
        ...
        try (Connection conn = ConexionDB.obtenerConexion();
            ...
            try (ResultSet rs = ps.executeQuery()) {
                if (rs.next()) {
                    String rol = rs.getString("ROL") != null
                            ? rs.getString("ROL").trim().toUpperCase()
                            : "";
                    ...
                    errorLogin = "Cédula o contraseña incorrecta.";
                }
            }
