...
<body>
    ...
    <main class="employee-page">
        <section class="employee-header">
            ...
            <p>
                Resumen operativo para alquileres activos, devoluciones del día y
                alertas de retraso.
            </p>
        </section>
        ...
        <section class="employee-metrics">
            <article class="retro-window employee-metric-card">
                <div class="window-header">
                    <span>Alquileres_Activos.cnt</span><span>_ □ X</span>
                </div>
            ...
            <article class="retro-window employee-metric-card">
                <div class="window-header">
                    <span>Devoluciones_Hoy.cnt</span><span>_ □ X</span>
                </div>
                <div class="employee-metric-body">
            ...
            <article class="retro-window employee-metric-card metric-danger">
                <div class="window-header">
                    <span>Alertas_Retraso.err</span><span>_ □ X</span>
                </div>
                <div class="employee-metric-body">
