                ...
                %>
                        <tr>
                            ...
                            <td><% if (devolucion == null) { %>
                                ...
                                <% } else { %><span>Completado</span><% } %>
                            </td>
                        </tr>
                        <%          }
                            if (!hayAlquileres) { %>
                        <tr>
                            <td colspan="10">No se encontraron alquileres con los filtros seleccionados.</td>
                        </tr>
                        <%          }
                        }
                    } catch (SQLException e) { %>
                        <tr>
                            <td colspan="10">No fue posible cargar los alquileres: <%= h(e.getMessage()) %></td>
                        </tr>
                        <%  } %>
                    </tbody>
                </table>
