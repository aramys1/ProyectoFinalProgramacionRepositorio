    ...
    <main class="employee-page">
        ...
        <section class="retro-window employee-panel">
            ...
            <div style="padding: 30px;">
                ...
                <form method="post">
                    ...
                    <select name="id_vhs" id="selectVhs" class="retro-search" style="width: 400px;" required onchange="calcularTotal()">
                        ...
                        try (Connection con = ConexionDB.obtenerConexion();
                            ...
                            while (rs.next()) {
                    %>
                        <option value="<%= rs.getInt("id_vhs") %>" data-precio="<%= rs.getDouble("precio_unidad") %>" data-titulo="<%= rs.getString("titulo").toLowerCase() %>">
                    ...
                    <input type="number" name="dias" id="dias" class="retro-search" min="1" max="14" value="1" style="width: 100px;" oninput="calcularTotal()">
                    ...
                    <a href="empleado-alquilar.jsp?paso=2" class="retro-button" style="background:#ccc; margin-left:10px;">CANCELAR</a>
                </form>
            </div>
        </section>
        <% } %>
        ...
        <section class="retro-window employee-panel">
            ...
            <div style="padding: 30px; text-align: center;">
                ...
                <a href="empleado-alquileres.jsp" class="retro-button" style="background:#ccc; margin-left:10px;">VER ALQUILERES</a>
            </div>
        </section>
        <% } %>
