        ...
        <section class="movie-detail-hero">
            ...
            <article class="movie-detail-copy">
                ...
                <div class="employee-form-actions">
                    ...
                    <form method="post" action="cliente-carrito.jsp">
                        <input type="hidden" name="accion" value="agregar" /><input type="hidden" name="id_pelicula" value="<%= idPelicula %>" /><button class="retro-button btn-rent" type="submit">
                            AGREGAR AL CARRITO
                        </button>
                    </form>
                    <% } else if (session.getAttribute("idUsuario") == null) { %><a class="retro-button btn-rent" href="login.jsp">INICIAR SESION PARA ALQUILAR</a>
                    <% } else if (clienteAutenticado) { %><button class="retro-button" type="button" disabled>
